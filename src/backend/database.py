...
# Example announcement shown to users until it expires
initial_announcements = [
    {
        "_id": "announcement-1",
        "message": "Activity registration is open until the end of the month. Don’t miss your chance to sign up!",
